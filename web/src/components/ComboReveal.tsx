...
export function ComboReveal({ combo, cards, previouslyFoundWords, onDismiss, onWordRevealed }: ComboRevealProps) {
  ...
  // Map from a "new" word's startPos to its ghost animation delay
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <div className="combo-reveal-words">
          {concat.split("").map((char, i) => {
            ...
            // If this letter belongs to a "new" word, share that word's stagger delay
            ...
            return (
              <span key={i} className="inline-flex items-center">
                ...
                <span className="combo-letter-wrapper">
                  ...
                  {/* Ghost "spirit" copy of this letter, aligned over its real counterpart */}
                  {isInNewWord && (
                    <span
