  ...
  return (
    <div className="grid w-full grid-cols-3 gap-2">
      <button
        ...
        className="h-14 w-full rounded-xl border-2 border-border px-3 text-sm font-medium transition-colors hover:bg-muted disabled:cursor-default disabled:opacity-30 cursor-pointer"
      >
        Clear
      </button>
      <button
        ...
        className="flex h-14 w-full items-center justify-center rounded-xl border-2 border-border transition-colors hover:bg-muted cursor-pointer"
      >
